...
"""TITA flat task config.

TITA flat environment — plane terrain, no height scanner, no terrain curriculum.
...
from .tita_rough_cfg import (
    get_tita_cfg,
    _TITA_DEFAULT_JOINT_POS,
    _TITA_SOFT_JOINT_POS_LIMIT_FACTOR,
    _TITA_SOFT_VEL_LIMIT_FACTOR,
    _TITA_SOFT_EFFORT_LIMIT_FACTOR,
...
def _tita_flat_cost_terms() -> dict:
    """Return cost terms for TITA NP3O constrained training (flat)."""
...
# ===========================================================================
# 4. TITA flat environment
# ===========================================================================


def tita_flat_env_cfg(
    num_envs: int = 4096,
    play: bool = False,
    flatten_policy_history: bool = False,
) -> ManagerBasedRlEnvCfg:
    """Build the TITA velocity-tracking environment configuration for flat terrain.
    ...
    cfg.cost_terms = _tita_flat_cost_terms()

    return cfg


def tita_flat_play_env_cfg(
    num_envs: int = 50,
    flatten_policy_history: bool = False,
) -> ManagerBasedRlEnvCfg:
    """Convenience wrapper: TITA flat play config (noise/randomization disabled)."""
    return tita_flat_env_cfg(num_envs=num_envs, play=True, flatten_policy_history=flatten_policy_history)
